<div class="df-new-4boxs">
	...
	<div class="df-top-caption">
		<h3 class="df-caption-popular">С ЭТИМ ТОВАРОМ ПОКУПАЮТ:</h3>
...
<div class="df-new-4boxs">
	...
	<div class="df-top-caption" id="df-margintop" >
		<h3 class="df-caption-popular">ПОХОЖИЕ ТОВАРЫ:</h3>		
		<div class="clear"></div>
	</div>
